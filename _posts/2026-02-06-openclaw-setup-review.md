...
구형 맥북의 한계를 넘어, 스스로를 잠가버린 '망고'의 희생으로 탄생한 하이브리드 AI 비서 '루나' 구축기를 소개합니다.
...
*   **정기 건강검진:** 매주 토요일 오전 9시, 루나는 스스로 시스템 업데이트와 보안 감사를 수행하고 그 결과를 노션 로그에 기록하며 용량 관리(임시 파일 정리)까지 수행합니다.
